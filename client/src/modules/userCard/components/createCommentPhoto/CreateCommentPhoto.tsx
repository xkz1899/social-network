...
import { createPhotoComment } from "../../service/userCardService"
import st from "./CreateCommentPhoto.module.scss"

interface ICreateComment {
	id: number
}

const CreateCommentPhoto = ({ id }: ICreateComment) => {
...
export default CreateCommentPhoto
